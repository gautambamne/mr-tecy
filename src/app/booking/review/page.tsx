                ...
                <Card className="shadow-sm">
                    <CardContent className="p-5 space-y-4">
                        ...
                        <div className="flex items-start gap-3">
                            ...
                            <div className="flex-1">
                                <p className="text-sm font-bold text-slate-900">{bookingData.location.label}</p>
                                <p className="text-sm text-slate-600">
                                    {bookingData.location.street}, {bookingData.location.city} - {bookingData.location.zipCode}
                                </p>
                            </div>
                        </div>
